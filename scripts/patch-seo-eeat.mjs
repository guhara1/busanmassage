...
function makeEeatSection(h1, url) {
  ...
  return `<section class="section eeat-section" data-eeat-section="true"><p class="eyebrow">부산마사지 운영 기준</p><h2>${cleanTitle} 이용 전 확인 기준</h2><div class="eeat-grid"><article class="eeat-card"><h3>지역 확인</h3><p>${regionText} 실제 상담 가능 범위와 배정 시간을 확인합니다. 같은 구군 안에서도 숙소, 상권, 주거지 위치에 따라 안내가 달라질 수 있습니다.</p></article><article class="eeat-card"><h3>요금 확인</h3><p>표기된 코스 금액은 참고 기준이며 최종 안내는 통화 시점의 시간대, 이동 조건, 선택 코스에 따라 확인합니다. 추가 조건은 예약 전에 먼저 안내하는 방식을 기준으로 합니다.</p></article><article class="eeat-card"><h3>신뢰 기준</h3><p>부산마사지는 위법하거나 부적절한 요청을 안내하지 않습니다. 이용 전 코스 범위, 결제 방식, 방문 가능 시간, 주의사항을 확인하도록 안내합니다.</p></article></div><p class="source-note">작성 기준: ${brand} 운영팀이 ${today} 기준 지역 상담 흐름과 예약 전 확인 항목을 정리했습니다.</p></section>`;
}
...
for (const file of walk(outDir)) {
  ...
  if (!html.includes("name=\"author\"")) {
    html = html.replace("<meta name=\"viewport\" content=\"width=device-width,initial-scale=1\">", `<meta name="viewport" content="width=device-width,initial-scale=1"><meta name="author" content="부산마사지 운영팀"><meta name="theme-color" content="#050505"><meta name="format-detection" content="telephone=yes">`);
  }
